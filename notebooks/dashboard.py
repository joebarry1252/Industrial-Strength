...
app.layout = html.Div([
    ...
    dcc.Tabs(id="tabs", children=[
        ...
        dcc.Tab(label='Generac Stock Data', children=[
            html.Div([
                html.H1("Generac Stocks High vs Lows", 
                        style={'textAlign': 'center'}),
              
                dcc.Dropdown(id='my-dropdown',
                             options=[{'label': 'Emerson', 'value': 'EMR'},
                                      {'label': 'Cummins','value': 'CMI'}, 
                                      {'label': 'Generac', 'value': 'GNRC'}], 
                             multi=True,value=['GNRC'],
                             style={"display": "block", "margin-left": "auto", 
                                    "margin-right": "auto", "width": "60%"}),
                dcc.Graph(id='highlow'),
                html.H1("Generac Market Volume", style={'textAlign': 'center'}),
...
def update_graph(selected_dropdown):
    dropdown = {"EMI": "Emerson","CMI": "CMI","GNRC": "Generac"}
    trace1 = []
    trace2 = []
...
def update_graph(selected_dropdown_value):
    dropdown = {"EMR": "Emerson","CMI": "CMI","GNRC": "Generac"}
    trace1 = []
